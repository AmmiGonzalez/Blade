...
<div class="reportesContainer">
  <div class="title mt-4 mx-5">
    <h4><b>Top 100 productos más vendidos por sucursal:</b> {{$sucursalActual[1]}}</h4>
  </div>
  <div class="container w-100 d-flex flex-row align-items-center justify-content-center mt-5">
    ...
    <script>
      $("#genReport").on('click', function() {
        window.location.href = '/reportes/top100vendidosSucursal?IDSucursal=' + $("#selectSucursal option:selected").val();
      });
    </script>
  </div>
