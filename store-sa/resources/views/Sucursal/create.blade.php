    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('guardar.sucursal') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input readonly id="latitud" type="text" class="form-control @error('latitud') is-invalid @enderror" name="latitud" value="{{ old('latitud', $sucursal->latitud) }}" required autocomplete="latitud" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input readonly id="longitud" type="text" class="form-control @error('longitud') is-invalid @enderror" name="longitud" value="{{ old('longitud', $sucursal->longitud) }}" required autocomplete="longitud" autofocus>
                        ...
                        <script>
                            function iniciarMapa(){
                                var latitud=14.834680085565713;
                                var longitud=-91.5183548762642;
