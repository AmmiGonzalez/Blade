                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('guardar.producto') }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="Precio" type="number" step="any" class="form-control @error('Precio') is-invalid @enderror" name="Precio" value="{{ old('Precio', $producto->Precio) }}" required autocomplete="Precio" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="PathImagen" type="file" class="form-control @error('PathImagen') is-invalid @enderror" name="PathImagen" value="{{ old('PathImagen') }}" required autocomplete="PathImagen" autofocus accept=".png, .jpg, .jpeg">
